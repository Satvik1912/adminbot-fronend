...
const Navbar = ({ toggleMobileSidebar }) => {
  ...
  return (
    <nav className="bg-white text-gray-800 shadow-md p-4 flex justify-between items-center">
      <div className="flex items-center">
        ...
        <div className="text-xl font-bold text-blue-600 lg:hidden">Loan System</div>
      </div>
      
      <div className="hidden md:flex items-center px-4 py-2 bg-gray-100 rounded-lg flex-1 max-w-xl mx-4">
